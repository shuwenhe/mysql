...
UPDATE sidsa_service.iot_variant SET sort=9999 WHERE id=99712;
UPDATE sidsa_service.iot_variant SET sort=9999 WHERE id>=99712 and id <= 100015;

-- 查找变量名并排序sort
SELECT id, imei, name, name_en, unit, sort,custom_group
FROM sidsa_service.iot_variant
WHERE imei = 240305005122847 AND name LIKE '%混合器当天落料量%'
