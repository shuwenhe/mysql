...
-- 240305005062748
-- 更新数据
SELECT * FROM xstiku_service.iot_variant WHERE imei = 240305005062748;
UPDATE xstiku_service.iot_variant SET sort=9999 WHERE id=100156;
UPDATE xstiku_service.iot_variant SET sort=9999 WHERE id>=100156 and id <= 100364;
