...
-- 240305005062883
-- 更新数据
SELECT * FROM xstiku_service.iot_variant WHERE imei = 240305005062883;
UPDATE xstiku_service.iot_variant SET sort=9999 WHERE id=100365;
UPDATE xstiku_service.iot_variant SET sort=9999 WHERE id>=100365 and id <= 100519;
